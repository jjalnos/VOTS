...
export const dictionary = {
  en: {
    ...
    demoNotice: "Sourced demonstration records — concise previews, not complete biographies.",
    signIn: "Sign in",
    signOut: "Sign out",
  ...
  es: {
    ...
    demoNotice: "Registros de demostración con fuentes: vistas breves, no biografías completas.",
